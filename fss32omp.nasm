...
cicloPesoTot4: 
    ...
    ADDPS XMM0, [EBX+ ESI*4+48]		; XMM0 = [v,v,v,v]
    ADD ESI, 16					; i=i+4
	JMP cicloPesoTot4	
...
cicloDistEuclidea4: 
    ...
    MOVAPS XMM3,[EAX+ESI*4 +32]      ;XMM0=[v1, v1, v1, v1]
	SUBPS XMM3, [EBX+ESI*4 +32]        ;XMM0=[v1-v2, v1-v2, v1-v2, v1-v2]
	MULPS XMM3, XMM3 ;XMM0=[v1-v2*v1-v2, v1-v2*v1-v2, v1-v2*v1-v2, v1-v2*v1-v2]
	ADDPS XMM1, XMM3   ;sommo le differenze dei quadrati sulle celle di XMM1
   
    MOVAPS XMM4,[EAX+ESI*4+48]      ;XMM0=[v1, v1, v1, v1]
    SUBPS XMM4, [EBX+ESI*4+48]        ;XMM0=[v1-v2, v1-v2, v1-v2, v1-v2]
	MULPS XMM4, XMM4  ;XMM0=[v1-v2*v1-v2, v1-v2*v1-v2, v1-v2*v1-v2, v1-v2*v1-v2]
	ADDPS XMM1, XMM4   ;sommo le differenze dei quadrati sulle celle di XMM1
